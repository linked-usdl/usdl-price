...
* 
* Id: ProviderStrategy.java, Project: CloudGen, 13 Apr 2013 Author: Jorge Araújo
*/
...
public class ProviderStrategy implements AttributeStrategy<String> {
	
	private static long serviceCount;
	
    public String getValue() throws PodamMockeryException {
            String service = "Provider_";
